...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bgApp.setGeometry(QRect(0, 0, 1920, 1080))
        ...
        self.toolbar.setGeometry(QRect(0, 50, 1921, 100))
...
"")
        ...
        self.notebookTitle.setGeometry(QRect(893, 8, 135, 30))
        font4 = QFont()
        ...
        self.rightButtons.setGeometry(QRect(1790, 0, 127, 50))
...
"}")
        ...
        self.maximizeRestoreAppBtn.setGeometry(QRect(66, 11, 28, 28))
...
"}")
        ...
        self.sections.setGeometry(QRect(0, 150, 1921, 40))
        ...
        self.pages.setGeometry(QRect(0, 150, 240, 931))
        ...
        self.addPage.setGeometry(QRect(0, 900, 240, 35))
        ...
        self.workspace.setGeometry(QRect(240, 190, 1681, 891))
